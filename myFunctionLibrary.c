...
printf("\t#############\n\n\n");
    ...
    printf("\tE-mail:");
    scanf("%s",email);
    printf("*Due to Cyber Security the Password choosing and Reteriving is bit difficult.\n*Please Follow following Instruction for a good Password.\n\n1-Password must contain Special Numeric keys.\n2-In case you Forget your Password you may face some serious Resistance, So it's better not to forget it.\n3-\"0-7\" Considered as Weak \"8-14\" Considered as Medium and \"15->\" is Considered as Password of Strong Strength.\n");
    passagain:
    printf("\tPassword:");
